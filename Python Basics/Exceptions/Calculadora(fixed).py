...
def loop_action():
    ...
    while True: #Ciclo de la lógica de la calculadora
        user_selection = display_options_menu_and_user_selection() #Llamamos a la función del menú.
        current_number = math_operation(current_number, user_selection) #Llamamos a la función lógica y sus parámetros.
